				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="card rounder-corner mnh-700">
						<div class="card-header rounder-top-corner">
                            <div class="row">
                                <div class="col-6">
							        <h1 class="number color_nero">Pedidos Pendentes</h1>
                                </div>
                            </div>
						</div>
						<div class="card-body">
							<div class="table_wrapper">
								...
								<table id="table_pendingOrders" class="display nowrap " style="width:100%">
									<thead>
										<tr>
									...
									<tbody>
										<tr>
											...
											<td class="" width="20%">
												<button type="button" class="lavender_blue_btn text-center" data-toggle="modal" data-target="#cofirmationModalAdmin">Acessar</button>
												<button type="button" class="gray_btn text-center" onclick="window.location.href='/dados-do-contrato'">Gerar Contrato</button>
