...
<div class="page-content--base sms_method">
	<div class="container-fluid p-0 full-height">
		...
		<div class="auth-content bg_nero color_white">
			<div class="col-xl-3 col-lg-4 col-sm-6 m-auto pr-3 pl-3">
				<h3 class="auth_page_description">enviamos seu código <br> por sms para <br> redefinir sua senha.</h3>
				<div class="auth-form pt_35">
					<!-- <form action="" method="post"> -->
						<div class="form-group pb-3">
							<input class="au-input au-input--full input-auth" type="" name="" value="" id="smsCode" placeholder="código" required>
							<center>
						...
						<div class="form-group">
							<button class="au-btn au-btn--block btn-white m-b-20 " onclick="window.location.href='/mudar-senha'">confirmar</button>
						</div>
					<!-- </form> -->
						<div class="form-group">
